...
def main():
    st.title("Instagram Content Creation")
    ...
    if st.button("Generate Suggestions"):
        if domain:
            ...
            if uploaded_image:
                ...
                suggestion = analyze_image_and_generate_suggestions("Instagram", image)
            else:
                suggestion = get_report_from_gemini("Instagram", domain)
    ...
    if st.button("Get Response"):
        if additional_prompt:
            ...
            response = get_report_from_gemini("Instagram", contextual_prompt)
